...
export default function CareerRoadmap() {
  ...
  const handleDownloadPDF = () => {
      ...
      generatedRoadmap.phases.forEach((phase, index) => {
        htmlContent += `
          <div class="phase">
            ...
            <div class="duration"> Duration: ${phase.duration}</div>
        `;

        if (phase.topics && phase.topics.length > 0) {
          htmlContent += `
            <div class="section-title">Topics to Learn:</div>
    ...
    printWindow.onload = function () {
      printWindow.print();
      // for closing the window after printing
      // printWindow.close();
    };
            ...
            <div className="bg-white rounded-xl shadow-md p-6 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="px-4 py-3 bg-linear-to-r from-[#048998] to-[#3bb4c1] text-white rounded-lg font-semibold flex items-center gap-2">
                    <FaBriefcase />
                    {userCareerTrack}
                  </div>
                </div>
          ...
          <>
            <div className="bg-white rounded-xl shadow-md p-4 md:p-8 mb-6">
              ...
              {generatedRoadmap?.jobApplicationTimeline && (
                <div className="mt-8 p-6 bg-linear-to-r from-green-50 to-green-100 border-2 border-green-200 rounded-xl">
