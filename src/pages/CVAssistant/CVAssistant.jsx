...
// // import { Download, User, Briefcase, Code, Award, Mail, Phone, MapPin, Linkedin, Github, Globe } from 'lucide-react';
...
// //   // Professional Summary Database
 

// //   let projects=[];

// //     if (Array.isArray(userPro?.projects)) projects = userPro?.projects;
...
// //     }
// //   const getSummary = () => {
// //     if (userPro?.careerTrack && summaryDatabase[userPro?.careerTrack]) {
// //       return summaryDatabase[userPro?.careerTrack][selectedSummary];
// //     }
// //     return "";
// //   };
...
// //           <h1 className="text-3xl font-bold text-slate-800 mb-4">CV Profile Assistant</h1>
...
// //             <div>
// //               <label className="block text-sm font-medium text-slate-700 mb-2">
// //                 Professional Summary (Select Variation)
// //               </label>
// //               <select
...
// //           <button
// //             onClick={downloadPDF}
// //             className="mt-6 w-full md:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition-colors flex items-center justify-center gap-2"
// //           >
// //             <Download size={20} />
// //             Download as PDF
// //           </button>
...
// //         {/* CV Preview */}
// //         <div id="cv-content" className="bg-white shadow-2xl rounded-lg overflow-hidden print:shadow-none print:rounded-none">
// //           {/* Header Section */}
// //           <div className="bg-gradient-to-r from-slate-800 to-slate-700 text-white p-8">
// //             <h1 className="text-4xl font-bold mb-2">{userPro?.name}</h1>
// //             <div className="flex flex-wrap gap-4 text-sm">
// //               {userData.email && (
// //                 <div className="flex items-center gap-2">
// //                   <Mail size={16} />
// //                   <span>{userPro?.email}</span>
// //                 </div>
// //               )}
// //               {userData.phone && (
// //                 <div className="flex items-center gap-2">
...
// //                       <h3 className="text-lg font-semibold text-slate-800">{userPro?.education}</h3>
// //                       <span className="text-slate-600 text-sm">{userPro?.department}</span>
// //                     </div>
// //                     <p className="text-slate-700 font-medium">{edu.degree}</p>
// //                     {edu.location && <p className="text-slate-600 text-sm">{edu.location}</p>}
// //                     {edu.gpa && <p className="text-slate-700 mt-1">CGPA: {edu.gpa}</p>}
// //                     {edu.thesis && (
...
// //                   <div className="mb-4">
// //                     <p className="text-slate-700 mt-2">{userPro?.job_experience}</p>
// //                   </div>
...
// //                   {userPro?.skills && userPro?.skills.length > 0 && (

// //                       <span className="text-slate-700">{userPro?.skills.join(', ')}</span>
...
// //             {/* Projects */}
// //             {userPro?.projects && projects.length > 0 && (
// //               <section className="mb-8">
// //                 <h2 className="text-2xl font-bold text-slate-800 border-b-2 border-slate-800 pb-2 mb-4">
// //                   Projects
// //                 </h2>
// //                 {userPro?.projects.map((project, index) => (
// //                   <div key={index} className="mb-4">
// //                     <h3 className="text-lg font-semibold text-slate-800">{project.title}</h3>
// //                     <p className="text-slate-700 mt-1">{project.description}</p>
// //                     <p className="text-slate-700 mt-1">{project.livelink}</p>
// //                     <p className="text-slate-700 mt-1">{project.githublink}</p>
...
// //                       </div>
// //                       <span className="text-slate-600 text-sm">{cert.year}</span>
// //                     </div>
// //                   </div>
// //                 ))}
// //               </section> */}
...
// //                   Problem-Solving
// //                 </h2>
// //                 <p className="text-slate-700">{userData.problemSolving}</p>
// //               </section>
// //             )} */}
...
// //                     <div className="flex justify-between items-start">
// //                       <div>
// //                         <h3 className="font-semibold text-slate-800">{achievement.event}</h3>
// //                         <p className="text-slate-700">{achievement.title}</p>
// //                         <p className="text-slate-600 text-sm">{achievement.organization}</p>
// //                       </div>
// //                       <span className="text-slate-600 text-sm">{achievement.year}</span>
// //                     </div>
// //                   </div>
// //                 ))}
// //               </section>
...
React.useEffect(() => {
  if (userPro) {
    setCvData({ ...userPro }); // Copy all user data into editable state
  }
}, [userPro]);
...
//   const handleDownloadFastPDF = async () => {
...
const handleDownloadFastPDF = () => {
  ...
  let y = 40; // Vertical starting point
  ...
  onChange={(e) =>
    setCvData((prev) => ({ ...prev, careerTrack: e.target.value }))
  }
