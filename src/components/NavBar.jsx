...
const NavBar = () => {
    ...
    return (
        <div className="navbar bg-[#048998] text-[#f6f5f5] font-Lato lg:text-xl text-[16px] lg:font-semibold px-6">
            {/* Left: Logo */}
                ...
                {user ? (
                    <div className="dropdown dropdown-end z-50">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            <li>
                                <Link to='/dashboard/addapet'>Dashboard</Link>
                            </li>
                            <li className='mt-2'>
                                <button onClick={logOut} className='bg-[#f1b963] w-full text-black'>
                                    Logout
                                </button>
                            </li>
                        </ul>
